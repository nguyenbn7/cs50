...
knowledge0 = And(
    ...
    # if A is a knight then A's sentence is true else false
...
knowledge1 = And(
    ...
    # if A's is a knight then A's sentence is true
    Implication(AKnight, And(AKnave, BKnave)),
    # if A is a knave then A's sentence is false
...
knowledge2 = And(
    ...
    # if B is a knight then B's sentence is true else false
...
knowledge3 = And(
    ...
    # if C is a knight then C's sentence is true else false
